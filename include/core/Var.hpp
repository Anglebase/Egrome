...
signals:
     ...
     * @param value 变化后的变量值
     */
    Signal<void(int value)> valueChanged;
...
public:
    ...
    Var<int> &operator++() { set(value_ + 1); return *this; }
    Var<int> &operator--() { set(value_ - 1); return *this; }
    Var<int> operator++(int) { set(value_ + 1); return value_ - 1; }
    Var<int> operator--(int) { set(value_ - 1); return value_ + 1; }
    Var<int> operator+=(int value) { set(value_ + value); return *this; }
    Var<int> operator-=(int value) { set(value_ - value); return *this; }
    Var<int> operator*=(int value) { set(value_ * value); return *this; }
    Var<int> operator/=(int value) { set(value_ / value); return *this; }
    Var<int> operator%=(int value) { set(value_ % value); return *this; }
    ...
    Var<int> operator*=(double value) { set(value_ * value); return *this; }
    Var<int> operator/=(double value) { set(value_ / value); return *this; }
};